...
libraryDependencies ++= Seq(
  "com.github.fkoehler" %% "play-html-compressor" % "1.1.0"
)
```

### History

* For Play Framework 2.8 use version 1.1.0
...
Documentation ([Scala](https://www.playframework.com/documentation/2.8.x/ScalaHttpFilters#Using-filters), [Java](https://www.playframework.com/documentation/2.8.x/JavaHttpFilters#Using-filters)).
